...
1. If the subject is of value to the wider community, consider commenting on an existing story, opening a new story or write a [RFC memo](development-workflow.md#RFCs).
...
We run our own Slack workspace at [pagopaspa.slack.com](https://pagopaspa.slack.com).
...
1. Always send an agenda in advance using [Fellow](https://pagopa.fellow.app), in order to let people understand if they must join the meeting or their presence is optional
